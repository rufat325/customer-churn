...
# Hidden customer-level purchasing tendency.
# This creates realistic correlation between historical
...
historical_weights = (
    customers["purchase_propensity"] + 0.05
)
...
future_weights = (
    customers["purchase_propensity"] ** 1.8 + 0.01
)
...
# ============================================================
# 5. Add accidental duplicate records
# ============================================================
...
print("Development data V2 generated successfully.")
